...
#SBATCH --output=wings_05_%A_%a.log
#SBATCH --error=wings_05_%A_%a.err
# ============================================================
# W.I.N.G.S. — GPU Simulation  (Array + Packing Hybrid)
#
# ABM with 0.5 initial infection fraction
# (CI threshold validation run)
# ============================================================
#
# Identical to submit_wings.sh except:
#   1. --infected-fraction 0.50  (was 0.10)
#   2. Output → abm_init05/     (separate from main gpu_results/)
#
...
#
# Submit:
#   sbatch submit_wings_05.sh
#
# Quick test (1 task, 30 days):
#   sbatch --array=0 --time=00:10:00 \
#          --export=ALL,QUICK=1 submit_wings_05.sh
#
